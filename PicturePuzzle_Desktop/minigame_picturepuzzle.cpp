...
{// called before start
	...
	//загружаем текстуры
	D3DX11CreateShaderResourceViewFromFile(comDevice, L"..\\PicturePuzzle_SharedCode\\res\\beyond.jpg", NULL, NULL, &textureShaderViews[0], NULL);
	D3DX11CreateShaderResourceViewFromFile(comDevice, L"..\\PicturePuzzle_SharedCode\\res\\fargus_souls.jpeg", NULL, NULL, &textureShaderViews[1], NULL);
	D3DX11CreateShaderResourceViewFromFile(comDevice, L"..\\PicturePuzzle_SharedCode\\res\\task_complete.png", NULL, NULL, &textureShaderViews[2], NULL);
	D3DX11CreateShaderResourceViewFromFile(comDevice, L"..\\PicturePuzzle_SharedCode\\res\\icon.png", NULL, NULL, &textureShaderViews[3], NULL);
}
...
void MiniGamePicturePuzzle::InitPipeline()
{
    ...
    ID3D10Blob *VS, *PS;
	HRESULT h1 = D3DX11CompileFromFile(L"..\\PicturePuzzle_SharedCode\\res\\shaders_2d.hlsl", 0, 0, "TextureVertexShader", "vs_5_0", 0, 0, 0, &VS, 0, 0);
    HRESULT h2 = D3DX11CompileFromFile(L"..\\PicturePuzzle_SharedCode\\res\\shaders_2d.hlsl", 0, 0, "TexturePixelShader", "ps_5_0", 0, 0, 0, &PS, 0, 0);
	...
	h1 = D3DX11CompileFromFile(L"..\\PicturePuzzle_SharedCode\\res\\shaders_font.hlsl", 0, 0, "FONT_VS", "vs_5_0", 0, 0, 0, &FONT_VS_Buffer, 0, 0);
    h2 = D3DX11CompileFromFile(L"..\\PicturePuzzle_SharedCode\\res\\shaders_font.hlsl", 0, 0, "FONT_PS", "ps_5_0", 0, 0, 0, &FONT_PS_Buffer, 0, 0);
